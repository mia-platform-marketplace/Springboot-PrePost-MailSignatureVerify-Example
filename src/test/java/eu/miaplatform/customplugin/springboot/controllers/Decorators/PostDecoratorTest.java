...
public class PostDecoratorTest {
    ...
    public PostDecoratorTest() {
        ...
        EmailMessage mockResponseMessage = new EmailMessage();
        mockResponseMessage.setFrom("me");
        mockResponseMessage.setTo("you");
        mockResponseMessage.setObject("important matters");
        mockResponseMessage.setBody("meet me at 9");
        mockResponseMessage.setEmailSignature(signatureForPkey);
        mockResponseMessage.setPubKey(pubKey);
        EmailMessage wrongMessage = new EmailMessage();
        wrongMessage.setFrom("me");
        wrongMessage.setTo("you");
        wrongMessage.setObject("important matters");
        wrongMessage.setBody("meet me at 7:30");
        wrongMessage.setEmailSignature(signatureForPkey);
        wrongMessage.setPubKey(pubKey);
